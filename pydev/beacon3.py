...
if __name__ == "__main__":
    ...
    ssk ='not found';
    for sss in ss :
        if sss.find("18:93:D7:46:14:D6") > 7 :
            flag = True
            ssk = sss
    ...
    # ss = bl.get_device_info("18:93:D7:46:14:D6").decode("utf-8")
    # print(ss)

    print(type(bl.get_available_devices()))
    # print(bl.get_output("devices").decode("utf-8").split(str("\r\n")))
